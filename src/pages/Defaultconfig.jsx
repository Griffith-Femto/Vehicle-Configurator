                ...
                <Box sx={{ display: 'flex', flexDirection: 'column', flexGrow: 1 }}>
                    ...
                    <Box sx={{ flex: 1, overflowY: 'auto', padding: '20px' }}>
                        ...
                        <div style={{ marginLeft: 20 }}>
                            ...
                            <Button variant="contained" color="success" style={{ marginRight: 20, marginBottom: 90 }}>Confirm Order</Button>
                            <Button variant="contained" color="success" style={{ marginRight: 20, marginBottom: 90 }} onClick={handleConfigure}>Configure</Button>
                            <Button variant="contained" color="success" style={{ marginRight: 20, marginBottom: 90 }}>Cancel</Button>
                        </div>
                    </Box>
                    <Footer />
