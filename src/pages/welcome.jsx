...
import { FormLabel, FormControl, Select, Button, TextField } from "@mui/material";
      ...
      <Box sx={{ display: 'flex', minHeight: '100vh' }}>
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', flexGrow: 1 }}>
          ...
          <Box sx={{ flex: 1, overflowY: 'auto', padding: '20px' }}>
            <FormControl component="form" onSubmit={handleSubmit} sx={{ width: "50%", marginLeft: 5 }}>
              <FormLabel sx={{ fontWeight: "bold", fontSize: "21px", paddingBottom: "10px", paddingTop: "20px" }}>Please Select:</FormLabel>
              <br />
              <Select
                name="segment"
              ...
              />
              <br />
              <Button variant="contained" type="submit" color="success" sx={{ maxWidth: "90px", marginBottom: "90px" }}>
                Submit
              </Button>
            </FormControl>
          </Box>
